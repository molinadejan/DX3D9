...
void cHead::Setup()
{
	...
	m_vecVertex[ 0].t.x = (float)24 / 64;	m_vecVertex[ 0].t.y = (float) 0 / 64;
	m_vecVertex[ 1].t.x = (float)16 / 64;	m_vecVertex[ 1].t.y = (float) 8 / 64;
	m_vecVertex[ 2].t.x = (float)16 / 64;	m_vecVertex[ 2].t.y = (float) 0 / 64;
	//¾Õ¸é À­»ï°¢ 

	m_vecVertex[ 3].t.x = (float)24 / 64;	m_vecVertex[ 3].t.y = (float) 0 / 64;
	m_vecVertex[ 4].t.x = (float)24 / 64;	m_vecVertex[ 4].t.y = (float) 8 / 64;
	m_vecVertex[ 5].t.x = (float)16 / 64;	m_vecVertex[ 5].t.y = (float) 8 / 64;
	//¾Õ¸é ¾Æ·§»ï°¢
	...
	m_vecVertex[17].t.x = (float)24 / 64;	m_vecVertex[17].t.y = (float)16 / 64;
	//¿ÞÂÊ¸é ¾Æ·§»ï°¢
